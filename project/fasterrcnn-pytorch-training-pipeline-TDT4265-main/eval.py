...
python eval.py --data data_configs/voc.yaml --weights outputs/training/mosaic_v2_dataaug_e30_AdamW_NoShuff/last_model_state.pth --model fasterrcnn_resnet50_fpn_v2
