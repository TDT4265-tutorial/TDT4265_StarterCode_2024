...
from dataloaders import load_cifar10, load_cifar10_with_data_augmentation
...
def main():
    ...
    dataloaders_with_data_augmentation = load_cifar10_with_data_augmentation(batch_size)
    ...
    trainer.train()
    trainer2 = Trainer(
        batch_size, learning_rate, early_stop_count, epochs, model, dataloaders_with_data_augmentation
    )
